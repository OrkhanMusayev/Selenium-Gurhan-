...
public class FirstSelenium {
    ...
    public static void main(String[] args) throws InterruptedException{
        ...
        //2- Creating the instance of the chrome driver to be able to do action on ChromeBrowser
        ...
        // String google URL = "https://www.google.com";
        ...
        Thread.sleep(2000);
        driver.navigate().forward(); //  This line will go to the page
